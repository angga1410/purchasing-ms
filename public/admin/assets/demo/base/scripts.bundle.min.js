...
$(document).ready(function () {
  ...
  (function (t) {
    ...
    if (void 0 === e)
      throw new Error(
        "Util class is required and must be included before mDatatable"
      );
      ...
      if (0 !== t(this).length) {
        ...
        var i = {
          ...
          init: function (e) {
            var a = !1;
            return (
              null === e.data.source && (i.extractTable(), (a = !0)),
              i.setupBaseDOM.call(),
              i.setupDOM(o.table),
              i.spinnerCallback(!0),
              i.setDataSourceQuery(
                i.getOption("data.source.read.params.query")
              ),
              ...
              t(i.getOption("search.input")).on("keyup", function (e) {
                (i.getOption("search.onEnter") && 13 !== e.which) ||
                  i.search(t(this).val());
              }),
              o
            );
          ...
          layoutUpdate: function () {
            i.setupSubDatatable.call(),
              ...
              i.resetScroll(),
              i.isInit ||
                (t(o).trigger("m-datatable--on-init", {
                      ...
                      t(this).ready(function () {
                        !(function (a) {
                          if (t(a).find(".m-datatable__lock").length > 0)
                            ...
                            0 !== t(a).find(".m-datatable__row").length
                          ) {
                            ...
                            t(a)
                              ...
                              e.lockEnabled.left.length > 0 &&
                                (t(o.wrap).addClass("m-datatable--lock"),
                                t(n).appendTo(a)),
                              (e.lockEnabled.left.length > 0 ||
          ...
          fullRender: function () {
            i.isLocked() &&
              (t(o.tableHead).empty(),
              i.setHeadTitle(),
              i.getOption("layout.footer") &&
                (t(o.tableFoot).empty(), i.setHeadTitle(o.tableFoot)),
              i.spinnerCallback(!0),
              ...
              t.each(o, function (t, n) {
                void 0 !== n.locked &&
                  (void 0 !== n.locked.left &&
                    e.getBreakpoint(n.locked.left) <= a &&
                    i.left.push(n.locked.left),
                  void 0 !== n.locked.right &&
                    e.getBreakpoint(n.locked.right) <= a &&
          ...
          afterRender: function (e, a) {
            a.table == t(o.wrap).attr("id") &&
              t(o).ready(function () {
                i.isLocked() ||
                  (i.redraw(),
                  i.getOption("rows.autoHide") &&
                    (i.autoHide(),
            ...
            t(window).scroll(function (t) {
              ...
              t(o.tableBody)
                ...
                .on("mouseenter", function () {
                  if (
                    ((i.hoverTimer = setTimeout(function () {
                      i.isScrolling = !1;
                    }, 200)),
                    !i.isScrolling)
                  ) {
          ...
          adjustLockContainer: function () {
            ...
            return (
              t(o.table).find(".m-datatable__lock--scroll").css("width", l), l
            );
          },
          dragResize: function () {
            var e,
            ...
            (o.initialDatatable = t(o).clone()),
              "TABLE" === t(o).prop("tagName")
                ? ((o.table = t(o)
                  ...
                  0 === t(o.table).parents(".m-datatable").length &&
                    (o.table.wrap(
                      t("<div/>")
                        .addClass("m-datatable")
                        .addClass("m-datatable--" + n.layout.theme)
                    ),
              ...
              t(o.table)
                ...
                .css("display", "block"),
              void 0 === t(o).attr("id") &&
                (i.setOption("data.saveState", !1),
                t(o.table).attr("id", e.getUniqueID("m-datatable--"))),
              i.getOption("layout.minHeight") &&
                t(o.table).css("min-height", i.getOption("layout.minHeight")),
              i.getOption("layout.height") &&
                t(o.table).css("max-height", i.getOption("layout.height")),
              null === n.data.type &&
                    ...
                    .each(function (n, r) {
                      ...
                      if (void 0 !== s && void 0 !== s.template) {
                        ...
                        "string" == typeof s.template &&
                          (d = i.dataPlaceholder(s.template, l)),
                    ...
                    .each(function (a, n) {
                      ...
                      if (void 0 !== o) {
                        ...
                        if (void 0 !== o.selector && !1 !== o.selector) {
                          if (
                            t(n).find('.m-checkbox [type="checkbox"]').length >
                            0
                          )
                            return;
                        ...
                        if (void 0 !== o.subtable && o.subtable) {
                          if (
                            t(n).find(".m-datatable__toggle-subtable").length >
                            0
                          )
                            return;
                          t(n)
              ...
              var a = function (a) {
                ...
                if (
                  ...
                  void 0 !== n.selector.class &&
                    t(l).addClass(n.selector.class),
                    t(o).children().html(l);
                }
              };
              n.layout.header &&
                a(t(o.tableHead).find(".m-datatable__row").first()),
                n.layout.footer &&
                  a(t(o.tableFoot).find(".m-datatable__row").first());
            }
          },
              ...
              t(e)
                ...
                .each(function (e, a) {
                  0 === t(a).find("span").length &&
                    t(a).wrapInner(t("<span/>").css("width", i.offset));
                });
          },
          scrollbar: function () {
            var a = {
              ...
              init: function () {
                ...
                if (n.layout.scroll) {
                  ...
                  t(r).find(".m-datatable__row").length > 0 && t(r).length > 0
                    ? ((a.scrollHead = t(o.tableHead).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (a.scrollFoot = t(o.tableFoot).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (a.tableLocked = t(o.tableBody).find(
                        ".m-datatable__lock:not(.m-datatable__lock--scroll)"
                      )),
                      i.getOption("layout.customScrollbar") &&
                      10 != e.detectIE() &&
                      l > e.getBreakpoint("lg")
                        ? a.initCustomScrollbar(r[0])
                        : a.initDefaultScrollbar(r))
                    : t(o.tableBody).find(".m-datatable__row").length > 0 &&
                      ((a.scrollHead = t(o.tableHead).find(
                        "> .m-datatable__row"
                      )),
                      (a.scrollFoot = t(o.tableFoot).find(
                      ...
                      10 != e.detectIE() &&
                      l > e.getBreakpoint("lg")
                        ? a.initCustomScrollbar(o.tableBody)
                        : a.initDefaultScrollbar(o.tableBody));
          ...
          initScrollbar: function (a, n) {
            if ((t(o.tableBody).css("overflow", ""), e.hasClass(a, "ps")))
              t(a).data("ps").update();
            else {
          ...
          setHeadTitle: function (a) {
            ...
            void 0 === r &&
              ((r = document.createElement("tr")), a.appendChild(r)),
          ...
          dataRender: function (e) {
              ...
              l = function (e) {
                var l = function (e, a) {
                  t(e.pager).hasClass("m-datatable--paging-loaded") ||
                    ...
                    t(e.pager)
                      .off()
                      .on("m-datatable--on-goto-page", function (n) {
                        t(e.pager).remove(), e.init(a);
                      });
            ...
            "local" === n.data.type ||
            (!1 === n.data.serverSorting && "sort" === e) ||
            (!1 === n.data.serverFiltering && "search" === e)
              ? l()
              : i.getData().done(l);
          },
          insertData: function () {
            ...
            var a = i.getDataSourceParam(),
              ...
              d = {};
            void 0 !== n.data.attr.rowProps &&
              n.data.attr.rowProps.length &&
              (d = n.data.attr.rowProps.slice(r, s));
            var c = document.createElement("tbody");
            c.style.visibility = "hidden";
            var m = n.columns.length;
            if (
              (t.each(o.dataSet, function (l, r) {
                ...
                for (var u = 0; u < m; u += 1) {
                  var p = n.columns[u],
                    f = [];
                  if (
                    (i.getObject("sort.field", a) === p.field &&
                      f.push("m-datatable__cell--sorted"),
                    void 0 !== p.textAlign)
                  ) {
                    var g =
                      void 0 !== o.textAlign[p.textAlign]
          ...
          getData: function () {
            ...
            if (
              ("local" === n.data.type && (e.url = n.data.source),
              "remote" === n.data.type)
            ) {
              (e.url = i.getOption("data.source.read.url")),
                "string" != typeof e.url &&
                  (e.url = i.getOption("data.source.read")),
                "string" != typeof e.url &&
                  (e.url = i.getOption("data.source")),
                ...
                t(o).trigger("m-datatable--on-ajax-fail", [e]),
                  t(o.tableBody).html(
                    t("<span/>")
                      ...
                      .html(i.getOption("translate.records.noRecords"))
                  ),
                  t(o.wrap).addClass("m-datatable--error m-datatable--loaded"),
                  i.spinnerCallback(!1);
              })
            ...
            var l = {
              ...
              init: function (e) {
                (l.meta = e),
                  ...
                  t(l.pager).hasClass("m-datatable--paging-loaded") ||
                    (t(l.pager).remove(),
                    0 !== l.meta.pages &&
              ...
              populate: function () {
                ...
                t("<li/>")
                  ...
                  t("<li/>")
                    ...
                    .appendTo(n),
                  i.getOption("toolbar.items.info") &&
                    (l.pagerLayout.info = t("<div/>")
              ...
              paste: function () {
                t.each(
                  t.unique(i.getOption("toolbar.placement")),
                  function (e, a) {
              ...
              gotoPage: function (e) {
                e.preventDefault(),
                  t(this).hasClass("m-datatable__pager-link--active") ||
                    l.openPage(parseInt(t(this).data("page")));
              },
              openPage: function (e) {
              ...
              addPaginateEvent: function (e) {
                t(o)
                  .off(l.paginateEvent)
                  .on(l.paginateEvent, function (e, a) {
                    i.spinnerCallback(!0),
                      (l.pager = t(o.table).siblings(".m-datatable__pager"));
                    ...
                    t(n)
                      ...
                      a.pages <= 1 &&
                        t(l.pager).find(".m-datatable__pager-nav").hide(),
                      i.setDataSourceParam("pagination", {
                        page: l.meta.page,
                        pages: l.meta.pages,
                        perpage: l.meta.perpage,
              ...
              updateInfo: function () {
                ...
                t(l.pager)
                  ...
                  .html(
                    i.dataPlaceholder(
                      i.getOption("translate.toolbar.pagination.items.info"),
                      {
                        start: e,
              ...
              pagingBreakpoint: function () {
                ...
                if (0 !== t(a).length) {
                  ...
                  t(a).find("li").show(),
                    t.each(
                      i.getOption("toolbar.items.pagination.pages"),
                      function (o, s) {
              ...
              paginationUpdate: function () {
                ...
                t(n).each(function (e, a) {
                  ...
                  p === l.meta.pages && p === t(m).last().data("page")
                    ? t(n).parent().hide()
                    : t(n).parent().show(),
                  1 === l.meta.page
                    ? (t(r)
          ...
          columnHide: function () {
            ...
            t.each(n.columns, function (n, i) {
              if (void 0 !== i.responsive) {
                var l = i.field,
                  r = t.grep(
                    t(o.table).find(".m-datatable__cell"),
                    function (e, a) {
                      return l === t(e).data("field");
                    }
                  );
                e.getBreakpoint(i.responsive.hidden) >= a
                  ? t(r).hide()
                  : t(r).show(),
                  e.getBreakpoint(i.responsive.visible) <= a
                    ? t(r).show()
                    : t(r).hide();
              }
            });
          ...
          setupSubDatatable: function () {
            ...
            if (
              "function" == typeof e &&
              !(t(o.table).find(".m-datatable__subtable").length > 0)
            ) {
              ...
              var a = function (a) {
                    ...
                    ((r = t("<tr/>")
                      ...
                      .append(
                        t("<td/>")
                          ...
                          .attr("colspan", i.getTotalColumns())
                      )),
                    t(l).after(r),
                  ...
                  t(l).hasClass("m-datatable__row--subtable-expanded")
                    ? (t(c).addClass(
                        i.getOption("layout.icons.rowDetail.collapse")
                      ),
                      t(l).removeClass("m-datatable__row--subtable-expanded"),
                      t(o).trigger("m-datatable--on-collapse-subtable", [l]))
                    : (t(c).addClass(
                        i.getOption("layout.icons.rowDetail.expand")
                      ),
                    ...
                    0 === t(s).find(".m-datatable").length &&
                      (t.map(o.dataSet, function (t, e) {
                        return (
                          d === t[n.columns[0].field] && ((a.data = t), !0)
                        );
                      }),
                      (a.detailCell = s),
                      (a.parentRow = l),
                        ...
                        if (void 0 !== o.subtable && o.subtable) {
                          ...
                          t(n).html(
                            t("<a/>")
                              ...
                              .attr("href", "#")
                              .attr("data-value", r)
                              .attr("title", i.getOption("detail.title"))
                              .on("click", a)
                              .append(
                                t("<i/>")
                                  .css("width", t(n).data("width"))
                                  .addClass(
                                    i.getOption(
                                      "layout.icons.rowDetail.collapse"
                                    )
          ...
          dataMapCallback: function (t) {
            var e = t;
            return "function" == typeof i.getOption("data.source.read.map")
              ? i.getOption("data.source.read.map")(t)
          ...
          spinnerCallback: function (t) {
            if (t) {
              if (!i.isSpinning) {
                ...
                void 0 !== e.message &&
                  !0 === e.message &&
                  (e.message = i.getOption("translate.records.processing")),
                  (i.isSpinning = !0),
          ...
          autoHide: function () {
            ...
            var e = function (e) {
              ...
              if (t(o).hasClass("m-datatable__row-detail"))
                t(this)
                  .find("i")
                  .removeClass(i.getOption("layout.icons.rowDetail.expand"))
                  .addClass(i.getOption("layout.icons.rowDetail.collapse")),
                  t(o).remove();
              else {
                t(this)
                  .find("i")
                  .removeClass(i.getOption("layout.icons.rowDetail.collapse"))
                  .addClass(i.getOption("layout.icons.rowDetail.expand"));
                    ...
                    t('<tr class="m-datatable__row"></tr>')
                      .append(
                        t('<td class="m-datatable__cell"></td>').append(
                          t("<span/>").css("width", i.offset).append(a.title)
                        )
                      )
                      .append(this)
                  );
            ...
            t(o.tableBody)
              ...
              .each(function () {
                t(this).prepend(
                  ...
                  0 ===
                  t(o.tableHead).find(".m-datatable__toggle-detail").length
                    ? (t(o.tableHead)
                        .find(".m-datatable__row")
                        .first()
                        .prepend(
          ...
          setAutoColumns: function () {
            i.getOption("data.autoColumns") &&
              (t.each(o.dataSet[0], function (e, a) {
                0 ===
                  t.grep(n.columns, function (t, a) {
                    return e === t.field;
              ...
              i.setHeadTitle(),
              i.getOption("layout.footer") &&
                (t(o.tableFoot).find(".m-datatable__row").remove(),
          ...
          stateKeep: function (t, e) {
            (t = i.getTablePrefix(t)),
              !1 !== i.getOption("data.saveState") &&
                (i.getOption("data.saveState.webstorage") &&
                  localStorage &&
                  localStorage.setItem(t, JSON.stringify(e)),
                i.getOption("data.saveState.cookie") &&
                  Cookies.set(t, JSON.stringify(e)));
          },
          stateGet: function (t, e) {
            if (
              ((t = i.getTablePrefix(t)), !1 !== i.getOption("data.saveState"))
            ) {
              var a = null;
              return null !=
                (a =
                  i.getOption("data.saveState.webstorage") && localStorage
          ...
          getTotalColumns: function (e) {
            return (
              void 0 === e && (e = o.tableBody),
              t(e).find(".m-datatable__row").first().find(".m-datatable__cell")
                .length
            );
          },
            ...
            var e = {
              ...
              setIcon: function () {
                ...
                if (!t.isEmptyObject(e)) {
                  ...
                  t(l).length > 0
                    ? t(l).removeAttr("class").addClass(r[e.sort])
          ...
          localDataUpdate: function () {
            ...
            if (
              (void 0 !== l && !0 !== i.getOption("data.serverSorting")
                ? "function" == typeof l.sortCallback
                  ? (o.dataSet = l.sortCallback(o.originalDataSet, n, l))
                  : (o.dataSet = i.sortCallback(o.originalDataSet, n, l))
                : (o.dataSet = o.originalDataSet),
              "object" == typeof e.query &&
                !i.getOption("data.serverFiltering"))
            ) {
              e.query = e.query || {};
              var r = function (t) {
                  for (var e in t)
          ...
          resetScroll: function () {
            void 0 === n.detail &&
              1 === i.getDepth() &&
              (t(o.table).find(".m-datatable__row").css("left", 0),
          ...
          rowEvenOdd: function () {
            t(o.tableBody)
              ...
              t(o.wrap).hasClass("m-datatable--subtable")
                ? t(o.tableBody)
                    .find(
          ...
          redraw: function () {
            return (
              i.adjustCellsWidth.call(),
              i.isLocked() &&
                (i.scrollbar(), i.resetScroll(), i.adjustCellsHeight.call()),
          ...
          setActive: function (e) {
            ...
            t(a)
              .closest(".m-datatable__lock")
              .parent()
              .find(".m-datatable__row:nth-child(" + n + ")")
              .addClass("m-datatable__row--active");
            var i = [];
            t(a).each(function (e, a) {
              var n = t(a)
          ...
          setActiveAll: function (e) {
            var a = t(o.table)
              .find("> tbody, > thead")
              .find("> tr:not(.m-datatable__row-subtable)")
              .find('.m-datatable__cell--check [type="checkbox"]');
            e ? i.setActive(a) : i.setInactive(a);
          },
          setSelectedRecords: function () {
            return (
              (o.API.record = t(o.tableBody).find(".m-datatable__row--active")),
              o
            );
          },
          ...
          row: function (e) {
            return (
              i.rows(e), (i.nodeTr = i.recentNode = t(i.nodeTr).first()), o
            );
          },
          rows: function (e) {
            return (
              (i.nodeTr = i.recentNode =
                t(o.tableBody).find(e).filter(".m-datatable__row")),
              o
            );
          },
          column: function (e) {
            return (
              (i.nodeCols = i.recentNode =
                t(o.tableBody).find(
          ...
          columns: function (e) {
            ...
            return (
              n.length > 0
                ? (i.nodeCols = i.recentNode = n)
                : (i.nodeCols = i.recentNode =
                    t(a).find(e).filter(".m-datatable__cell")),
              o
            );
          },
          cell: function (e) {
            return (
              i.cells(e), (i.nodeTd = i.recentNode = t(i.nodeTd).first()), o
            );
          },
          cells: function (e) {
          ...
          visible: function (e) {
            if (t(i.recentNode.length)) {
              ...
              if (i.recentNode === i.nodeCols) {
                ...
                if (i.isLocked()) {
                  var l = t(i.recentNode).closest(
                    ".m-datatable__lock--scroll"
                  ).length;
                  l
                    ? (o += a.left.length + 1)
                    : t(i.recentNode).closest(".m-datatable__lock--right")
                        .length && (o += a.left.length + l + 1);
                }
              }
              e
                ? (i.recentNode === i.nodeCols &&
                    delete n.columns[o].responsive,
                  t(i.recentNode).show())
                : (i.recentNode === i.nodeCols &&
                    i.setOption("columns." + o + ".responsive", {
                      hidden: "xl",
                    }),
                  t(i.recentNode).hide()),
                i.redraw();
        ...
        if (
          ...
          if ("string" == typeof n) {
            var l = n;
            void 0 !== (o = t(this).data("mDatatable")) &&
              ((n = o.options),
  ...
  return {
    ...
    initHeader: function () {
      ...
      (a = mUtil.get("m_header")),
        (o = { offset: {}, minimize: {} }),
        "minimize" == mUtil.attr(a, "m-minimize-mobile")
          ? ((o.minimize.mobile = {}),
            (o.minimize.mobile.on = "m-header--minimize-on"),
            (o.minimize.mobile.off = "m-header--minimize-off"))
          : (o.minimize.mobile = !1),
        "minimize" == mUtil.attr(a, "m-minimize")
          ? ((o.minimize.desktop = {}),
            (o.minimize.desktop.on = "m-header--minimize-on"),
            (o.minimize.desktop.off = "m-header--minimize-off"))
    ...
    initAside: function () {
      var n, i, l, r, s, d, c, m;
      (l = mUtil.get("body")),
        (r = mUtil.get("m_aside_left")),
        (s = mUtil.hasClass(r, "m-aside-left--offcanvas-default")
        ...
        mUtil.hasClass(l, "m-aside-left--fixed") &&
          (mUtil.addEvent(r, "mouseenter", function () {
            i && (clearTimeout(i), (i = null)),
              (n = setTimeout(function () {
                mUtil.hasClass(l, "m-aside-left--minimize") &&
                  mUtil.isInResponsiveRange("desktop") &&
                  (mUtil.removeClass(l, "m-aside-left--minimize"),
                  mUtil.addClass(l, "m-aside-left--minimize-hover"),
                  e.scrollerUpdate(),
                  e.scrollerTop());
              }, 300));
          }),
          mUtil.addEvent(r, "mouseleave", function () {
            n && (clearTimeout(n), (n = null)),
              (i = setTimeout(function () {
                mUtil.hasClass(l, "m-aside-left--minimize-hover") &&
                  mUtil.isInResponsiveRange("desktop") &&
                  (mUtil.removeClass(l, "m-aside-left--minimize-hover"),
                  mUtil.addClass(l, "m-aside-left--minimize"),
                  e.scrollerUpdate(),
                  e.scrollerTop());
              }, 500));
          })),
        (c = mUtil.get("m_ver_menu")),
        (m =
          "1" === mUtil.attr(c, "m-menu-dropdown") ? "dropdown" : "accordion"),
        "1" === mUtil.attr(c, "m-menu-scrollable") &&
          (d = {
            height: function () {
