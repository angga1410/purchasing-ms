...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	...
	<form action="{{ route('update_purchase_order_verify') }}" method="post">
			...
			<div class="row" id="m_user_profile_tab_1">
				...
				<div class="col-md-6">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-md-7">
							<select class="form-control m-input m-input--square" name="verified" required="true">
								<option @if($data->approved == 1) selected="selected" @endif value="1">Verify</option>
				...
				<div class="m-form__actions">
					<div class="row justify-content-end">
						<div class="">
							...
							<a href="{{ route('purchase_order_verify') }}">
...
<script type="text/javascript">
	//
	function getItemTable(dataid) {
		console.log(poId)
		$(function() {
			var table = $('#table').DataTable({
				processing: true,
				serverSide: true,
				ajax: "{{ URL::to('items/tablepo2') }}/" + dataid,
				columns: [{
						data: 'mfr',
						name: 'mfr'
					},
