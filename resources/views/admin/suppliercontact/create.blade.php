...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
		...
		<a href="#" id="m_aside_left_minimize_toggle" class="m--padding-top-5-desktop m--margin-right-5">
			...
			<div class="mr-auto">
				<h3 class="m-subheader__title ">Create Supplier Contact</h3>
			</div>
		</div>
	</div>

	<div class="tab-content padding40px shadowDiv">
		<form action="{{ route('save_supplier_contact') }}" method="post">
			{!! csrf_field() !!}
			<div class="row" id="m_user_profile_tab_1">
					<div class="col-md-6">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input required="" name="contact_name" class="form-control m-input" type="text">
							</div>
						</div>
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input required="" name="contact_position" class="form-control m-input" type="text">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input required="" name="contact_hand_phone" class="form-control m-input" type="text">
							</div>
						</div>
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input required="" name="contact_email" class="form-control m-input" type="text">
							</div>
						</div>
					</div>
