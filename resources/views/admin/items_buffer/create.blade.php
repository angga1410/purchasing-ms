...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
		...
		<a href="#" id="m_aside_left_minimize_toggle" class="m--padding-top-5-desktop m--margin-left-10-desktop">
			...
			<div class="mr-auto">
				<h3 class="m-subheader__title ">Create Item Buffer</h3>
			</div>
		</div>
	</div>	
	<form action="{{ route('save_item_buffer') }}" method="post" enctype="multipart/form-data">
			...
			<div class="row" id="m_user_profile_tab_1">
					<div class="col-md-6">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input required="" name="convert_product_id" class="form-control m-input" type="text">
							</div>
						</div>
