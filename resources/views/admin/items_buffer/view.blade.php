...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
		...
		<a href="#" id="m_aside_left_minimize_toggle" class="m--padding-top-5-desktop m--margin-left-10-desktop">
			...
			<div class="mr-auto">
				<h3 class="m-subheader__title ">Update/View Item Buffer</h3>
			</div>
		</div>
	</div>	
	<form action="{{ route('update_item_buffer') }}" method="post" enctype="multipart/form-data">
			...
			<div class="row" id="m_user_profile_tab_1">
					<div class="col-md-6">
						...
						<div class="form-group m-form__group row">
							<label for="example-text-input" class="col-md-3 col-form-label">Convert Product Id</label>
							<div class="col-md-7">
								<input required="" name="convert_product_id" value="{{ $data->convert_product_id }}" class="form-control m-input" type="text">
							</div>
						</div>
					...
					<div class="col-md-6">
						...
						<!-- <div  class="form-group m-form__group row itemPrice">
						...
						<div class="m-form__actions">
							<div class="row">
								...
								<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">Update</button>&nbsp;&nbsp;
									<a href="{{ route('item_buffer_list') }}"><div class="btn btn-accent m-btn m-btn--air m-btn--custom">Cancel</div></a>
								</div>
							</div>
						</div>
					</div>
