...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	...
	<form action="{{ route('save_price_quote') }}" method="post" enctype="multipart/form-data">
						...
						<div class="m-form__actions">
							<div class="row">
								<div class="col-12">
									...
									<a href="{{ route('price_quote_list') }}"><div class="btn btn-accent m-btn m-btn--air m-btn--custom">Cancel</div></a>
								</div>
							</div>
						</div>
					</div>
