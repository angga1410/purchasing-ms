...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
      ...
      <a href="#" id="m_aside_left_minimize_toggle" class="m--padding-top-5-desktop m--margin-left-10-desktop">
			...
			<div class="mr-auto">
				<h3 class="m-subheader__title ">Item(Product) Price Quote List</h3>
        <a href="{{ route('create_price_quote') }}" class="btn btn-accent m-btn m-btn--air m-btn--custom">Create</a>
			</div>
		</div>
