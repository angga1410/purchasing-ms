...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
		...
		<a href="#" id="m_aside_left_minimize_toggle" class="m--padding-top-5-desktop m--margin-left-10-desktop">
			...
			<div class="mr-auto">
				<h3 class="m-subheader__title ">Update/View Item Quote</h3>
			</div>
		</div>
	</div>	
	<form action="{{ route('update_item_quote') }}" method="post" enctype="multipart/form-data">
						...
						<div class="m-form__actions">
							<div class="row">
								<div class="col-12">
									...
									<a href="{{ route('item_quote_list') }}"><div class="btn btn-accent m-btn m-btn--air m-btn--custom">Cancel</div></a>
								</div>
							</div>
						</div>
					</div>
